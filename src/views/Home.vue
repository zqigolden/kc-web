  ...
  <div>
    ...
    <div class="content">
      <v-alert border="left" class="mb-2 pt-2" outlined>
        ...
        <div>
          <a target="_blank" href="https://note.com/noro_rakugaki/n/n13e129137d74" >【お知らせ】制空シミュで作成した共有URL の廃止について</a>
        </div>
      </v-alert>
    </div>
    <div class="content">
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              ...
              <div class="mt-4">
                ...
                <div class="text--secondary">(e.g.) https://zqigolden.github.io/kc-web?predeck={"version":4,"hqlv":120,"f1":{"s1":...</div>
              </div>
              <div class="mt-6">
                <div>{{ $t("Home.URLが長すぎて上記の方法でエラーが出る場合は、URL fragmentsを利用した受け渡しも可能です。") }}</div>
                <div class="text--secondary">(e.g.) https://zqigolden.github.io/kc-web#import:{"predeck":{"version":4,"hqlv":120,"f1":{"s1":...}</div>
              </div>
              <div class="mt-6">
                <div>{{ $t("Home.また、URL fragmentsを利用した形式では艦隊分析コード(艦娘、装備)形式の読み込みも同時に行うことができます。") }}</div>
                <div class="text--secondary">
                  (e.g.)
                  https://zqigolden.github.io/kc-web#import:{"predeck":{...},"ships":[{"api_ship_id":1,"api_lv":1,"api_kyouka":[0,0,0,0,0,0,0],"api_exp":[0,100,0],"api_slot_ex":0,"api_sally_area":0}],"items":[{"api_slotitem_id":1,"api_level":10}]}
                </div>
              </div>
            </v-expansion-panel-content>
          </v-expansion-panel>
