  ...
  <v-app v-resize="onResize">
    ...
    <v-main>
      <div class="event-banner mb-3" v-if="true">
        <v-img class="banner-normal" :src="`./img/util/bn_250307.png`" />
        <v-img class="banner-on" :src="`./img/util/bn_250307_on.png`" />
      </div>
      <div class="event-banner mb-3" v-if="true">
        <v-img class="banner-normal" :src="`./img/util/bn_250322.png`" />
        <v-img class="banner-on" :src="`./img/util/bn_250322_on.png`" />
      </div>
          ...
          <div class="site-setting-bodies">
            <div>
              ...
              <div class="site-setting-body">
                <div>
                  <v-btn class="mr-3" @click="changeLocale('ja')" :class="{ primary: isJapanese, secondary: !isJapanese }">日本語</v-btn>
                  <v-btn class="mr-3" @click="changeLocale('en')" :class="{ primary: isEnglish, secondary: !isEnglish }">English</v-btn>
                  <v-btn class="mr-3" @click="changeLocale('cn')" :class="{ primary: isChinese, secondary: !isChinese }">Chinese</v-btn>
                </div>
                <div>
